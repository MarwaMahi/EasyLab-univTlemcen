          ...
          <div class="container col-xs-12">
            ...
            <form class="well form-horizontal" action="{{ url('actualites') }}" method="post"  id="contact_form" enctype="multipart/form-data">
              ...
              <fieldset>
                ...
                <!-- Form Name -->
                <legend><center><h2><b>Nouvelle actualite</b></h2></center></legend><br>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                      ...
                      <div class="col-md-9 inputGroupContainer  @if($errors->get('texte')) has-error @endif">
                        <div style="width: 70%">
                          <textarea name="texte" class="form-control" rows="3" placeholder="Texte ...">{{old('texte')}}</textarea>
                          <span class="help-block">
                                @if($errors->get('texte'))
                                  @foreach($errors->get('texte') as $message)
                                    <li> {{ $message }} </li>
                                  @endforeach
                                @endif
                            </span>
                 ...
                 <div class="form-group ">
                        <label class="col-xs-3 control-label">Membres (*)</label>  
                  ...
                  <div class="form-group ">
                        ...
                        <div class="col-xs-9 inputGroupContainer">
                          <div style="width: 70%">
                            <input  name="date_publication" class="form-control" type="Date" value="{{old('date_publication')}}">
                          </div>
                        </div>
                  </div> 
