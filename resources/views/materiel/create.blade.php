...
@section('title','LRI | Nouveau materiel')
          ...
          <div class="container col-xs-12">
            ...
            <form class="well form-horizontal" action="{{url('materiels')}}" method="post"  id="contact_form" enctype="multipart/form-data">
              ...
              <fieldset>
                ...
                <legend><center><h2><b>Nouveau materiel</b></h2></center></legend><br>
                  ...
                  <div class="form-group ">
                        ...
                        <div class="col-xs-9 inputGroupContainer @if($errors->get('numero')) has-error @endif">
                          <div style="width: 70%">
                            <input  name="numero" class="form-control" placeholder="Numéro" type="text" value="{{old('numero')}}">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-md-9 inputGroupContainer @if($errors->get('libelle')) has-error @endif">
                        <div style="width: 70%">
                          <textarea class="form-control" name="libelle" rows="3" placeholder="libellé ...">{{old('libelle')}}</textarea>
                          <span class="help-block">
               ...
               <input  name="dateAffectation" class="form-control" placeholder="jj-mm-aaaa" type="hidden" value="{{ date('Y-m-d') }}">
