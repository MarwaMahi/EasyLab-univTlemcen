                ...
                <legend><center><h2><b>Nouveau projet</b></h2></center></legend><br>
                  ...
                  <div class="form-group ">
                   ...
                   <div class="form-group ">
                        ...
                        <div style="width: 70%">
                          <select name ="partenaire[]"  class="form-control select2 " multiple="multiple" data-placeholder="Selectionnez les partenaire" value="{{old('partenaire[]')}}">
                         ...
                         <div class="form-group ">
                        <label class="col-xs-3 control-label"> Contact des partenaires (*)</label> 
                        <div class="col-md-9 inputGroupContainer @if($errors->get('contact[]')) has-error @endif"> 
                        <div style="width: 70%">
                          <select name ="contact[]"  class="form-control select2 " multiple="multiple" data-placeholder="Selectionnez les conatacts" value="{{old('contact[]')}}">
                              <option></option>
                             ...
                             <a href=" {{url('contacts/create')}} " type="button" class="btn" data-toggle="modal"><i class="fa fa-plus"></i> Nouveau contact</a>
                                <span class="help-block">
