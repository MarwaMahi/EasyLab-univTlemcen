...
@section('title','LRI | Liste des partenaire')
...
@section('header_page')
      ...
      <ol class="breadcrumb">
        ...
        <li class="fa fa-dashboard"><a href="{{url('projets')}}">Partenaires</a></li>
          ...
          <div class="row" style="padding-bottom: 20px">
            ...
            <div class="box-body">
              ...
              <div class="pull-right">
                <a href="{{url('partenaires/create')}}" type="button" class="btn btn-block btn-success btn-lg"><i class="fa fa-plus"> Nouveau Partenaire</i></a>
              </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        @if(Auth::user()->role->nom == 'admin'  )
                        <a href="{{ url('partenaires/'.$partenaire->id.'/edit')}}" class="btn btn-default">
                        ...
                        <!-- <button type="submit" class="btn btn-danger ">
                         ...
                         <a href="#supprimer{{ $partenaire->id }}Modal" role="button" class="btn btn-danger" data-toggle="modal"><i class="fa fa-trash-o"></i></a>
