            ...
            <form class="well form-horizontal" action=" {{url('articles/'. $article->id) }}" method="post"  id="contact_form">
              ...
              <fieldset>
                ...
                <legend><center><h2><b>Modifier article</b></h2></center></legend><br>
                  ...
                  <div class="form-group">
                    <label class="col-md-3 control-label">contacts des partenaires (*)</label>
                    <div class="col-md-9 inputGroupContainer">
                      <div style="width: 70%">
                        <select name="contacts[]" class="form-control select2 " multiple="multiple" data-placeholder="Selectionnez les Membres">
                          <option>
                           ...
                           @foreach($contacts as $contac)
                              <option value="{{$contac->id}}">
                                {{$contac->nom}} {{ $contac->prenom }}
                              </option>
                           @endforeach
                        </select>
