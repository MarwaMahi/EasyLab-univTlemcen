          ...
          <div class="row" style="padding-bottom: 20px">
            ...
            <div class="box-body">
              ...
              <div class="pull-right">
                <a href="{{url('contactts/'.$article->id.'/create')}}" type="button" class="btn btn-block btn-success btn-lg"><i class="fa fa-plus"> Créer Contact</i></a>
              </div>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                   ...
                   <td>
                      <div class="btn-group">
                        <form action="{{ url('contactts')}}" method="post">
