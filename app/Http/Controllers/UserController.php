...
class UserController extends Controller
{
     ...
     public function detailsF($id)
    {
        ...
        $equipes = Equipe::all(); 
        $roles = Role::all();
        $projets = DB::select('SELECT projets.intitule FROM projets,projet_user,users WHERE users.id=? AND projet_user.user_id=? AND projets.id=projet_user.projet_id',[$id,$id]);
